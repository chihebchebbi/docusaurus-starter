...
![](https://www.redcanary.com/wp-content/uploads/image2-25.png#logo)
...
![](https://i1.wp.com/www.omanobserver.om/wp-content/uploads/2019/09/cyber-attack.jpg?resize=800%2C445&amp;ssl=1#logo)
...
![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/github.png)

Disable Windows defender

![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/off.png)

Extract the zip file:

![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/zip.png)

The techniques can be found in the &quot;atomics&quot; folder:

![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/files.png)

Now Open powershell and type:

`powershell -ExecutionPolicy bypass`

![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/bypass.png)

Install a required module:

`Install-Module -Name powershell-yaml`

![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/installmodule.png)
...
![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/invoke.png)

Enter the project folder and then type:

`Import-Module ./Invoke-AtomicRedTeam.psm1`

![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/importmodule.png)
...
![](https://github.com/chihebchebbi/mkdocs-base/raw/master/docs/img/techniques.png)
